...
function confirmacionEliminacion(id) {
    ...
    if (confirmacion) {
        ...
        window.location.href = 'confirmacionE.php?accion=eliminar&id=' + encodeURIComponent(id);
    } else {
        // Si el usuario no confirma, redirige a la página anterior
        window.location.href = 'tablaEquipo.php'; // O la página que desees
    }
}
...
function confirmarActualizacion(id) {
    ...
    if (confirmacion) {
        ...
        window.location.href = 'confirmacionE.php?accion=modificar&id=' + encodeURIComponent(id);
    } else {
        // Si el usuario no confirma, redirige a la página de equipos
        window.location.href = 'tablaEquipo.php'; // O la página que desees
    }
}
