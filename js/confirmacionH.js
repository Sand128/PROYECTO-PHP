...
function confirmacionEliminacion(id) {
    ...
    if (confirmacion) {
        ...
        window.location.href = 'confirmacionH.php?accion=eliminar&id=' + encodeURIComponent(id);
    } else {
        // Si el usuario no confirma, redirige a la página anterior
        window.location.href = 'tablaHerramien.php'; // O la página que desees
    }
}
...
function confirmarActualizacion(id) {
    ...
    if (confirmacion) {
        ...
        window.location.href = 'confirmacionH.php?accion=modificar&id=' + encodeURIComponent(id);
    } else {
        // Si el usuario no confirma, redirige a la página de herramientas
        window.location.href = 'tablaHerramien.php'; // O la página que desees
    }
}
