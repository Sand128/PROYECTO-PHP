...
<body class="<?php echo $typeClass; ?>">
    ...
    <div class="container">
        ...
        <!-- Aquí se mostrará una tabla con las prácticas asignadas al administrativo -->

        <h2>Manipular Información del Inventario</h2>
        <!-- Formulario para manipular información del inventario -->
